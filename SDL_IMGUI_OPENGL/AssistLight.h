...
namespace AssistLight
{
    glm::mat4 ComputeLightSpaceMatrix(const glm::vec3& lightPosition, const glm::vec3& lightDirection, const glm::mat4& camView, const glm::mat4& camProj)
    {

        glm::vec3 lookTarget = lightPosition + lightDirection;
        glm::mat4 lightView = glm::lookAt(lightPosition, lookTarget, glm::vec3(0.0f, 0.0f, 1.0f));
